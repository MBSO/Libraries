...
/***********************************************************************/
// Description: function to restrict the input (text) field to numbers only and format for currency input
// Author: Open source
// Last updated: 15/05/2017 16.33
// Use: 
...
/***********************************************************************/
// Description: function to validate email address using regex
// Author: Open source
// Last updated: 15/05/2017 16.33
// Use: 
//  if (isEmail(email)) {...
...
/***********************************************************************/
// Description: function to validate if UK postcode format
// Author: 
// Last updated: 15/05/2017 16.33
// Use: 
//  isUKPostCode('strPostCode');
/***********************************************************************/
function isUKPostCode(strPostCodeCheck) {
  ...
  for ( var i=0; i<pcexp.length; i++) {
    ...
    if (pcexp[i].test(postCode)) {
      ...
      if (strPostCodeCheck.toUpperCase() == 'AI-2640') {postCode = 'AI-2640'};
...
/***********************************************************************/
// Description: Typeof detection functions
// Author: 
// Last updated: 15/05/2017 16.33
/***********************************************************************/
